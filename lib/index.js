...
export default class Timeline extends Component {
    ...
    case "two-column":
        ...
        return <View key={rowID}>{content}
        {this._renderDropDown(rowData, sectionID, rowID)}
    ...
    _renderDropDown(rowData, sectionID, rowID) {
        return this.props.showDropDown == rowData.dropDownData && this.props.showDropDownNew ? (
            <View
            style={{
    ...
    >
        {this.props.dropDownContent(rowData)}
    </View>
    ) : null;
    }
    ...
    _renderCircle(rowData, sectionID, rowID) {
        ...
        break;
            case "dot":
                let dotStyle = {
                    height:(this.props.dotSize) ? this.props.dotSize : circleSize / 2,
                    width: (this.props.dotSize) ? this.props.dotSize : circleSize / 2,
                    borderRadius: (this.props.dotSize) ? this.props.dotSize / 2 : circleSize / 4,
